...
export default function DropSpaceDashboard() {
  ...
  const recentShares = [
    { id: 1, name: 'mars-colony-plans.pdf', size: '15.2 MB', shared: '2 hours ago', expires: 'Never', downloads: 3 },
    { id: 2, name: 'europa-base-v2.zip', size: '458 MB', shared: '1 day ago', expires: 'In 6 days', downloads: 12 },
    { id: 3, name: 'io-mining-data.csv', size: '2.3 MB', shared: '3 days ago', expires: 'In 4 days', downloads: 7 },
    { id: 4, name: 'ganymede-water-samples.tar', size: '1.2 GB', shared: '1 week ago', expires: 'Expired', downloads: 45 },
  ]
            ...
            {uploadProgress > 0 && (
              <div className="mt-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-slate-300">Uploading to Jupiter relay...</span>
                  ...
                  <tr key={share.id} className="border-b border-slate-800/50">
                    ...
                    <td className="py-4">
                      <div className="flex items-center space-x-2">
                        <button className="p-1 text-slate-400 hover:text-white" title="Copy link">
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
